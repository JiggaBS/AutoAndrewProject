...
BEGIN
  ...
  IF length(trim(p_body)) = 0 AND (p_attachments IS NULL OR jsonb_array_length(p_attachments) = 0) THEN RAISE EXCEPTION 'EMPTY_MESSAGE'; END IF;
...
-- =============================================
-- STEP 10: FIX EXISTING GOOGLE AUTH PROFILES
-- =============================================
